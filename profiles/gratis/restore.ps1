# Restore Gratis Profile (100% Free Models)
# Switch global OpenCode config to free models with auto-fallback combos
...
Write-Host "=== Restore Gratis Profile ===" -ForegroundColor Cyan
Write-Host "Models: oc/mimo-v2.5-free -> oc/deepseek-v4-flash-free -> kr/claude-sonnet-4.5" -ForegroundColor Gray
